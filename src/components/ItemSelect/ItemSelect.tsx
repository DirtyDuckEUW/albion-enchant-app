...
const ITEM_OPTIONS: Array<{ value: ItemKey; label: string }> = [
  { value: "head_boots_offhand_cape", label: "Helmet / Boots / Off-Hand / Cape" },
...
export default function ItemSelect({ value, onChange, label = "Item-Kategorie" }: ItemSelectProps) {
  return (
    <label className="field">
      <span>{label}</span>
      <select value={value} onChange={(e) => onChange(e.target.value as ItemKey)}>
